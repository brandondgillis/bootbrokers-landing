# Fix blog files with proper UTF-8 encoding

blog_index = """import Head from 'next/head';
...
blog_slug = """import Head from 'next/head';
import Link from 'next/link';
...
# Write files
with open('pages/blog/index.js', 'w', encoding='utf-8') as f:
    f.write(blog_index)
    
with open('pages/blog/[slug].js', 'w', encoding='utf-8') as f:
    f.write(blog_slug)

print("? Blog files created successfully with UTF-8 encoding!")
